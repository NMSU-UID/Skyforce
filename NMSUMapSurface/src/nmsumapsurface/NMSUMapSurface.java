 ...
 *
 */
public class NMSUMapSurface extends ApplicationTemplate{
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 ...
		 //......NMSU Main Campus's Geographic Location.......// 
        Configuration.setValue(AVKey.INITIAL_ALTITUDE,1187.00d);
        Configuration.setValue(AVKey.INITIAL_LATITUDE,32.278774d);
        Configuration.setValue(AVKey.INITIAL_LONGITUDE,-106.747906d);

        ApplicationTemplate.start("NMSU Main Campus", AppFrame.class);
